...
function [overall_residual_vector, flag, new_data] = batchChemReactorModel_IDA(t,XZ,XZp,ida_user_data_struct) % x_tot contains both x (differential states), z (algebraic variables) and derivates of states
...
%         T_degC = ida_user_data_struct.Usym;
    ...
    [overall_residual_vector] = batchChemReactorModel(t,XZ,XZp,ida_user_data_struct,T_degC);
